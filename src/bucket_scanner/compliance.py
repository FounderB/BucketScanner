...
COMPLIANCE_TAGS: dict[str, list[str]] = {
    ...
    "encryption/sse-s3-only": ["CIS-3.11", "NIST-SC-28"],
    "object-lock/disabled": ["NIST-CP-9", "SOC2-A1.2"],
    ...
    "aws/block-public-access-missing": ["CIS-1.5", "NIST-AC-3"],
    "aws/account-public-access-missing": ["CIS-1.5", "NIST-AC-3"],
    ...
    "chain/privileged-public-blast": ["NIST-AC-6", "NIST-AC-3"],
