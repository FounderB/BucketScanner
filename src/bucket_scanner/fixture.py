    ...
    for item in data.get("buckets", []):
        buckets.append(
            BucketSnapshot(
                ...
                encryption_algorithm=item.get("encryption_algorithm"),
                encryption_kms_key_id=item.get("encryption_kms_key_id"),
                object_lock_enabled=item.get("object_lock_enabled"),
